<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="cadastro-pipeline.aspx.cs" Inherits="PortalOnDemand.cadastro_pipeline" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container body-content">
        <br />
        <h3>Cadastro Pipeline</h3>
        <div class="row">
            <div class="form-group col-md-3">
                <label>Pipeline</label>
                <asp:TextBox ID="txtPipeline" runat="server" class="form-control" required="" placeholder="Nome do pipeline"></asp:TextBox>
            </div>
        ...
        <div id="param_1" runat="server">
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <asp:TextBox ID="TextBoxParametro_1_nome" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
                 <div class="form-group col-md-3">
                    <label>Texto de ajuda para o usuário</label>
                    <asp:TextBox ID="TextBoxParametro_1_ajuda" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div id="param_2" runat="server">
             <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <asp:TextBox ID="TextBoxParametro_2_nome" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
                 <div class="form-group col-md-3">
                    <label>Texto de ajuda para o usuário</label>
                    <asp:TextBox ID="TextBoxParametro_2_ajuda" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div id="param_3" runat="server">
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <asp:TextBox ID="TextBoxParametro_3_nome" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
                 <div class="form-group col-md-3">
                    <label>Texto de ajuda para o usuário</label>
                    <asp:TextBox ID="TextBoxParametro_3_ajuda" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div id="param_4" runat="server">
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <asp:TextBox ID="TextBoxParametro_4_nome" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
                 <div class="form-group col-md-3">
                    <label>Texto de ajuda para o usuário</label>
                    <asp:TextBox ID="TextBoxParametro_4_ajuda" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div id="param_5" runat="server">
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <asp:TextBox ID="TextBoxParametro_5_nome" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
                <div class="form-group col-md-3">
                    <label>Texto de ajuda para o usuário</label>
                    <asp:TextBox ID="TextBoxParametro_6_ajuda" runat="server" class="form-control" required=""></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <br />
        <br />
        <small style="color:red;" id="projetoHelp" class="form-text text-muted">Para que o data owner consiga fazer upload no flat file, é necessário o pipeline está vinculado a um projeto data quality.<br /> Caso não seja vinculado a um projeto, ele poderá apenas executar o pipeline cadastrado</small>
        <br />
        <br />
        <div class="alert alert-success" role="alert" id="mensagemOk" runat="server">
            Sucesso - Pipeline cadastrado com sucesso.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="alert alert-danger" role="alert" id="mensagemErro" runat="server">
            Erro - Pipeline não foi cadastrado.
             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
             </button>
        </div>
