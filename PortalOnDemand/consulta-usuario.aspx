<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="consulta-usuario.aspx.cs" Inherits="PortalOnDemand.consulta_usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container body-content">
        ...
        <div class="col text-right">
            <a href="cadastro-usuario.aspx" class="btn btn-primary">Novo Usuario</a>
        </div>
        <br />
