<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="cadastro-usuario.aspx.cs" Inherits="PortalOnDemand.cadastro_usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container body-content">
        ...
        <div class="alert alert-danger" role="alert" id="mensagemErro" runat="server">
            Erro - Usuário não foi cadastrado.
             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
             </button>
        </div>
